      ...
      <div class="chart tab-pane active" id="projects">
        <div class="box-body">
            <div class="table-responsive network-participants-image">
                ...
                <a target="_blank" href="/admin/network_diagrams/projects"><img class="img-responsive" src="/img/projects.png" alt="Network diagram of projects in the portfolio"></a>
                <div style="text-align: right;"><a target="_blank" href="/admin/network_diagrams/projects">Click to interact</a></div>
            </div>
        </div>
        <!-- /.box-body -->
      </div>
      ...
      <div class="chart tab-pane" id="participants">
        <div class="box-body">
            <div class="table-responsive network-participants-image">
                ...
                <a target="_blank" href="/admin/network_diagrams/participants_academic"><img class="img-responsive network-participants-image" src="/img/participants.png" alt="Network diagram of organisations participating in the portfolio"></a>
                Click to interact: <a target="_blank" href="/admin/network_diagrams/participants_all">All participants</a> <a target="_blank" style="padding-left:5px;" href="/admin/network_diagrams/participants_academic">Academic participants</a> <a target="_blank" style="padding-left:5px;" href="/admin/network_diagrams/participants_efpia">EFPIA participants</a>
            </div>
        </div>
        <!-- /.box-body -->
      </div>
      ...
      <div class="chart tab-pane" id="publications">
        <div class="box-body">
            <div class="table-responsive network-participants-image">
                ...
                <a target="_blank" href="/admin/network_diagrams/publications"><img class="img-responsive" src="/img/collaborators.png" alt="Network diagram of collaborating organisations on publications"></a>
            </div>
        </div>
        <!-- /.box-body -->
      </div>
