                    ...
                    <div class="table-responsive">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="padding-right: 4%;padding-left: 4%;">
                                ...
                                <h4><strong>Interactive participant map (EFPIA)</strong></h4>
                                <p>This map represents the network of EFPIA-related organisations who participate in the IMI neurodegeneration (ND) portfolio. Each node in the network represents a single participating organisation.</p>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                <iframe loading="lazy" src="/plugins/efpia-partners" width="870" height="700"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
