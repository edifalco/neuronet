                ...
                <ul class="dropdown-menu" role="menu">
                    @foreach($projects as $project)
                        @if($project->name == $project_name)
                            <li><a href="/plugins/tools/project/{{ $project->id }}"><b><u>{{ $project->name }}</u></b></a></li>
                        @else
                            <li><a href="/plugins/tools/project/{{ $project->id }}">{{ $project->name }}</a></li>
                        @endif
                    @endforeach
                </ul>
            </div>
            @if($project_name)
                <a class="btn btn-info" href="/plugins/tools">Applied filter: "{{ $project_name }}" <u>Click here to remove it</u></a>
            @endif
        </div>
